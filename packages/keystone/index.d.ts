...
export interface BaseApp {
  prepareMiddleware(args?: { dev: boolean, distDir: string; keystone: Keystone }): void | Promise<void>;
...
export { default as Keystone } from './lib/Keystone';
export { BaseKeystoneAdapter, BaseListAdapter, BaseFieldAdapter } from './lib/adapters';
